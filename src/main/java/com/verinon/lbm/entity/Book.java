package com.verinon.lbm.entity;
...
public class Book
{
    ...
    public Book(int book_id, String book_name, String book_authors, Double book_price, String book_dept, Date book_published, Date book_date_of_barrow, Date book_date_of_return, boolean is_book_available) {
