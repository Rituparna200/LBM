...
public class Member
{
    ...
    public Member(int member_id, String member_name, String member_address, long member_phone_number, Date member_joined_date, double member_fee,String member_dept, String member_gender,int member_age) {
        this.member_id = member_id;
        this.member_name = member_name;
        this.member_address = member_address;
        this.member_phone_number = member_phone_number;
