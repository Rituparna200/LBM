...
public class MemberController
{
    ...
    {
        model.addAttribute("member",new Member(0,"username","address",1234567890,new Date(),125.25,"Computer","male/female",21));

        return "addmember";
    }

    @PostMapping("/add-member")
    public String addMemberSuccess(ModelMap model,Member member)
    {
