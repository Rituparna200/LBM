...
import com.verinon.lbm.repository.BookRepository;
...
public class BookController
{
    ...
    {
        model.addAttribute("book",new Book(0,"BookName", "Author Names", 100.25, "Department", new Date(),new Date(), new Date(), true));
        return "addbook";
    }

    @PostMapping("/add-book")
    public String addBooks(ModelMap model,Book book)
    {
